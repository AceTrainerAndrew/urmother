...
class DialogueBox extends FlxSpriteGroup
{
	...
	if (PlayState.SONG.song.toLowerCase() == "siu")
		{
	...
	if (PlayState.SONG.song.toLowerCase() == "outage")
		{
			portraitLeft = new FlxSprite(-20, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('cbPortrait','week2');
	...
	else if (PlayState.SONG.song.toLowerCase() == "corrupt")
        {
            ...
            portraitRight.frames = Paths.getSparrowAtlas('weeb/acePortrait');
            portraitRight.animation.addByPrefix('enter', 'ace portrait enter', 24, false);
	...
	if (PlayState.SONG.song.toLowerCase() == "corrupt")
		{
			portraitRight = new FlxSprite(0, 40);
            portraitRight.frames = Paths.getSparrowAtlas('weeb/acePortrait');
            portraitRight.animation.addByPrefix('enter', 'ace portrait enter', 24, false);
